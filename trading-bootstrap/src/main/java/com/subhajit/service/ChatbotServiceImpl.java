...
import com.subhajit.dto.CoinDto;
import com.subhajit.response.ApiResponse;
import com.subhajit.response.FunctionResponse;

@Service
public class ChatbotServiceImpl implements ChatbotService {

    @Value("${gemini.api.key}")
    private String geminiSecretKey;
    ...
    public CoinDto makeApiRequest(String currencyName) throws Exception {
        ...
        ResponseEntity<Map> responseeEntity = restTemplate.getForEntity(url, Map.class);
        Map<String, Object> responseBody = responseeEntity.getBody();
    ...
    public FunctionResponse getFunctionResponse(String prompt) {
        String GEMINI_API_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key="+geminiSecretKey;

        // Create JSON request body using chaining
    ...
    public String simpleChat(String prompt) {
        String GEMINI_API_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key="+geminiSecretKey;
